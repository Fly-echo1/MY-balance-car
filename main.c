...
int main(void)
{
 ...
 OLED_Init();
 OLED_Clear();
 OLED_ShowString(0,0,"I'm back !",16);
 MPU_Init();
 mpu_dmp_init();
 HAL_TIM_Encoder_Start(&htim2,TIM_CHANNEL_ALL);
 HAL_TIM_Encoder_Start(&htim4,TIM_CHANNEL_ALL);
 OLED_ShowString(0,4,"Init Success",12);
